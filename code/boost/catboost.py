...
def merge_df(df_dict, base_df):
    ...
    temp_df[category_f] = temp_df[category_f].astype("str")
...
def main(args):
    ...
    not_use = ["time", "label", "user_most_genre", "movie_popularity","writer", "director", "director_most_genre","director_most_viewed_genre", "writer_most_genre","writer_most_viewed_genre",'genre_items','genre_popularity','writer_popularity','writer_items','director_popularity','director_items']
    ...
    #사용할 카테고리 피쳐 지정
    cat_features = ["user", "item", "year","user_favotrite_genre"]
